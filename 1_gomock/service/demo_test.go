...
func TestDemoService_InsertData(t *testing.T) {
	Convey("TestDemoService_InsertData", t, func() {
		Convey("should return tips and err", func() {
		...
		Convey("should return empty and err", func() {
		...
		Convey("should return success and nil", func() {
...
func TestDemoService_CheckAndUpdateData(t *testing.T) {
	...
	Convey("TestDemoService_CheckAndUpdateData", t, func() {
...
func TestDemoService_CheckConnect(t *testing.T) {
	Convey("TestDemoService_CheckConnect", t, func() {
		Convey("全局变量打桩", func() {
			// given
...
func TestDestroyResource(t *testing.T) {
	Convey("TestDestroyResource", t, func() {
		Convey("过程打桩", func() {
			// given
